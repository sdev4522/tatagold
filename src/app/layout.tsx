...
export const metadata: Metadata = {
  ...
  description: 'Official Tata Gold PVC Wires & Cables. Premium Flame Retardant (FR/FRLS) 99.99% Electrolytic Pure Copper electrical wires for residential & industrial safety. ISI Certified.',
  keywords: [
    'Tata Gold PVC Wires',
  ...
  openGraph: {
    ...
    description: '100% Pure Electrolytic Copper PVC Insulated Wires & Cables for maximum electrical safety and energy savings.',
  ...
  twitter: {
    ...
    description: 'ISI Certified Flame Retardant 99.99% Pure Copper Electrical Wires.',
...
<<<<<<< HEAD
    ...
    description: 'Manufacturer of ISI Certified 100% Electrolytic Pure Copper PVC Insulated Flame Retardant Wires and Cables.',
    knowsAbout: [
      'PVC Wires',
...
<<<<<<< HEAD
=======
        <link rel="icon" href="/images/tg-favicon.png" />
        <link
